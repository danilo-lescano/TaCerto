...
TaCerto.Estrutura.Fase = {
	...
	1: {
		...
		descricaoObjetivos: ['consiga 20 moedas ao fim do jogo','pule uma pergunta utilizando a carta vermelha','termine o jogo com no máximo 70s',],
	},
	2: {
		tipo: 'Aleatorio',
		param:{
	...
	4: {
		...
		funcObjetivos: ['moedasMinimas', 'usarMinimoCarta', 'tempoMaximo'],
		descricaoObjetivos: ['consiga 30 moedas ao fim do jogo','pule uma pergunta utilizando a carta vermelha','termine o jogo com no máximo 50s',],
	},
	5: {
		tipo: 'Aleatorio',
		param:{
